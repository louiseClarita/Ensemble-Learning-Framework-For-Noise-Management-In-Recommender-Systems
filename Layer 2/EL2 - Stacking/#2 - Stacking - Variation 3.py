...
def get_stacking():
   ...
   # level0.append(('xgb', XGBClassifier(use_label_encoder=False, eval_metric='logloss', random_state=42)))
    level0.append(('gbc', GradientBoostingClassifier(random_state=42)))
...
final_output.to_csv(r'C:\\Users\\clari\\Desktop\\M2 - Thesis\\Research\\Dr Jacques Bou Abdo\\Recommender System\\5 - Ensemble Learning Model\\output\\'+dataset_name+'\\' + dataset_name + '_el2.3_TestWithNF_fine_tuning.csv', index=False)
